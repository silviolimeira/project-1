...
public class Periodo implements Comparable<Periodo> {
	...
	public boolean equals(Object o) {
		...
		if (horaEntrada != periodo.horaEntrada)
			return false;
		if (minutoEntrada != periodo.minutoEntrada)
			return false;
		if (horaSaida != periodo.horaSaida)
			return false;
		if (minutoSaida != periodo.minutoSaida)
			return false;
		if (minutosEntrada != periodo.minutosEntrada)
			return false;
		if (minutosSaida != periodo.minutosSaida)
			return false;
		if (entrada != null ? !entrada.equals(periodo.entrada) : periodo.entrada != null)
			return false;
